...
BOT_MENU_MEMO_DESCRIPTION = (
    "Provide any additional memo you'd like me to consider when assisting you. Your notes help me understand what's important to you."
)
...
SUBJECT_SET_MESSAGE = (
    "Great choice! Your subject is now set to \"{subject}\". I will generate a tailored question for you by tomorrow, or if you're ready to dive in now, just type /question to get your first challenge!"
)

CURRENT_SUBJECT_MESSAGE = (
    "Your current subject is: {subject}. I is working on a new question that you'll receive tomorrow. If you're eager to get started now, use /question to try a question immediately."
)
...
GENERATING_QUESTION_MESSAGE = (
    "Hang tight! I'm crafting a question just for you. This will only take a moment..."
)

QUESTION_GENERATION_FAILED_MESSAGE = (
    "Oops, something went wrong while generating your question. Please try again later while our technicians look into the issue."
)
...
CHECKING_SOLUTION_MESSAGE = (
    "Thanks! Let me submit your answer to the judge. We'll see how you did shortly!"
)

SUBMIT_SOLUTION_PROMPT_MESSAGE = (
    "It seems you forgot to include your answer. Please submit it with /solve followed by your answer, so I can help you evaluate it."
)
